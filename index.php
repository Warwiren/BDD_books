...
$routes = [
    '/books' => [BooksController::class, 'index'], //liste des livres avec une edition
    '/allbooks' => [BooksController::class, 'indexAll'], //tous les livres
    '/books/search' => [BooksController::class, 'oneBook'], //rechercher un livre
    '/books/add' => [BooksController::class, 'addBook'], // ajouter un livre
    '/books/delete' => [BooksController::class, 'deleteBook'], //supprimer un livre
    ...
    '/books/author' => [BooksController::class, 'authorBook'], // les livres d'un auteur
